...
try:
    ...
    print("Button pressed, Starting square drive.")
    ...
    for square in range(3):
        print(f"Starting square {square+1}")
        for side in range(4):
            print(f"Side {side+1}: forward")
            Movement.drive(forward_power, forward_time, 90)   
            ...
            print("Turning right...")
            Movement.drive(turn_power, turn_time, 35)         # steer right
            Movement.coast()
            time.sleep(0.5)

        print(f"Completed square {square+1}")
        time.sleep(1)

    print("All squares complete, braking.")
    Movement.brake()
